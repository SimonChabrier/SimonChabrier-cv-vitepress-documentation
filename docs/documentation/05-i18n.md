---
title: Système i18n
description: Traductions et internationalisation du portfolio.
---
...
**Path** = Chemin dans l'objet JSON (séparé par des points)
...
Dans les fichiers JSON, j'utilise `{{nomVariable}}` pour indiquer où insérer des données dynamiques.
...
[← Sources de Données](04-sources-donnees.md) | [Retour à l'index](README.md) | [Circulation des Données →](06-circulation-donnees.md)
